...
function cards () {
     ...
     class MenuCard {
      ...
      (0,_modules_services_services__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3000/menu')
              .then(data => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function tabs (tabsSelector, tabsContentSelector, tabsParentSelecctor, activeClass) {
    //Tabs
    const tabs = document.querySelectorAll(tabsSelector),
          tabsContent = document.querySelectorAll(tabsContentSelector),
          tabsParent = document.querySelector(tabsParentSelecctor);
...
function timer(id, deadLine) {
     ...
     function setClock(selector, endtime) {
       ...
       function updateClock() {
         const t = getTimeRameining(endtime); 
...
window.addEventListener('DOMContentLoaded', () => {
      ...
      (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-11-30');
